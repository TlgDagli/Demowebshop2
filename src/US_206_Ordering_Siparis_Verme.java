...
public class US_206_Ordering_Siparis_Verme extends BaseDriver {
    ...
    public void US_206() throws AWTException {
        ...
        Assert.assertTrue(driver.getCurrentUrl().contains("https://demowebshop.tricentis.com/onepagecheckout"),"Ödeme sayfasına geçilemedi.");
        ...
        Assert.assertTrue(shippingAddress.getText().equals(billingADDRESS),"Adresler uyuşmuyor.");
        ...
        Assert.assertTrue(dogrulama.getText().contains("Credit Card"), "Ödeme yöntemi seçtiğinizden farklıdır.");
        ...
        Assert.assertTrue(successfully.getText().contains("successfully"),"Siparişiniz başarılı bir şekilde oluşturulamadı.");
